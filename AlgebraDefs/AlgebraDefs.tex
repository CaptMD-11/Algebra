...
\begin{section}{Section 16.2 - Integral Domains and Fields}
    \begin{enumerate}
        ...
        \item The characteristic of a ring R is the least positive integer $n$ such that $nr=0$ for all $r \in R$. If no such $n$ exists, the characteristic of $R$ is defined to be 0. (denote the characteristic of $R$ by $\textrm{char} R$). 
    \end{enumerate}
\end{section}
